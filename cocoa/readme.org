...
+ =(install-view-in-window VIEW WINDOW)= [Function]

  #+begin_src lisp :exports results
  (documentation #'install-view-in-window t)
  #+end_src
...
+ =(remove-view-from-window VIEW)= [Function]

  #+begin_src lisp :exports results
  (documentation #'remove-view-from-window t)
  #+end_src
...
+ =(dialog-item-enable ITEM)= [Function]
...
+ =(dialog-item-disable ITEM)= [Function]
